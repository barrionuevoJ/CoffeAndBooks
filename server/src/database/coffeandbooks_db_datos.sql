...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2023 a las 21:01:25
...
(1, 'Evil Thiago', 'Pizarra', 'evilthiago@gmail.com', '$2a$10$chTijepdDjQSsEOQUA5l2eND4vfrQ61PXABrWxDb6L8NbefPe4s7W', 'default-user.png'),
(2, 'Julian', 'Barrionuevo', 'julianbarrionuevo10@gmail.com', '$2a$10$HC7yBeNKloOa0UssmI8yoeLHBA5GaLwOdkyXVp7AU50ZoLoUIk0fC', 'user-img-1680741202868.jpeg'),
(3, 'Kiara', 'Ramos', 'kiarramos@gmail.com', '$2a$10$Gf45YBVAt1dvxEBgvx8z1.NeHK5GZlpqKd5OK5UoRryMmJHP9DFAq', 'user-img-1680741482826.jpeg'),
(4, 'Vicenzo', 'Rubio', 'vaclod892@gmail.com', '$2a$10$MyfpxXa6XWThLikVkcifJeFb7o2.WuDeZJBUvcje929VfKZrZRc9m', 'user-img-1680825070740.png'),
(5, 'Walter', 'White', 'Heisenberg@gmail.com', '$2a$10$Ph8rYsFBgO7eaLMnCY4N/eKY9LIbDt4XkO50RMwDyQNEAwSmzi7ru', 'user-img-1680801454630.jpg'),
(6, 'Leon', 'Kennedy', 'leoncapo@gmail.com', '$2a$10$sQFAZuacVSgYAwp4JxrsNOsDJCNcCIK57VIsoUAbMdFcjGO4gunX2', 'user-img-1680932215990.jpg'),
(8, 'alby', 'Ramos', 'kiararamosrocha1@gmail.com', '$2a$10$JDusjA6pjoM.nAW4l6EzVO5J/hsmYPrpO8EWe7.L1JnQykBohL9Am', 'default-user.png'),
(9, 'Toro max', 'iiiii', 'toromax@gmail.com', '$2a$10$X/ZEcKh8iRVvEEBsBhWJJOhn3dLUTvrwbYFmm7/2hH23.tVvd45wG', 'default-user.png');
COMMIT;
